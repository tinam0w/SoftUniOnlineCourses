...
public class GetVillainsNames {
    private static final String GET_VILLAINS_NAMES = "select v.name, count(distinct mv.minion_id) as count_of_minions " +
            "from villains as v " +
    ...
    private static final String COLUMN_COUNT_OF_MINIONS = "count_of_minions";
    ...
    private static void print(ResultSet resultSet) throws SQLException {
        ...
        final int count_of_minions = resultSet.getInt(COLUMN_COUNT_OF_MINIONS);
